...
import { ArrowRight, Sparkles, CheckCircle2, Circle, Quote, Camera, Activity, MessageSquare, BarChart2, Gamepad2, Bell, MapPin, Phone, Navigation } from 'lucide-react';
...
const ONBOARDING_STEPS = [
    {
        ...
        description: 'Agar RANSTAL bisa membantumu dengan tepat, pilihlah target kesehatan perjalanan wisata utama yang ingin dicapai.'
    },
    {
        title: 'Selamat Datang di RANSTAL',
        description: 'Ransel Digital Travel Health Nursing untuk menjaga keselamatan dan kesehatan anak selama perjalanan wisata.'
    },
    {
    ...
    {
        title: 'Konsultasi RANSTAL AI',
        description: 'Tanyakan apa saja seputar kesehatan perjalanan, pertolongan pertama, dan tips aman selama wisata langsung ke AI pintar kami.'
    }
];
            ...
            <div className="home-container animate-fade-in" style={{ justifyContent: 'center', alignItems: 'center', minHeight: '80vh', paddingBottom: '0' }}>
                <div className="login-card glass-card">
                    <div className="logo-placeholder login-logo-large" style={{ margin: '0 auto 24px auto', width: '84px', height: '84px', fontSize: '32px' }}>
                        <img className="app-logo-img" src={ranstalLogo} alt="RANSTAL logo" />
                    </div>
                    <h2 className="app-name" style={{ textAlign: 'center', marginBottom: '8px' }}>RANSTAL</h2>
                    ...
                    <form onSubmit={handleLogin} className="login-form">
                        ...
                        <label style={{ display: 'flex', gap: '8px', marginTop: '14px', alignItems: 'flex-start', textAlign: 'left' }}>
                            ...
                            <span style={{ fontSize: '12px', color: '#475569' }}>
                                Saya menyetujui Kebijakan Privasi dan penggunaan data sesuai layanan RANSTAL.
                            </span>
                        </label>
                        {authError && (
        ...
        <div className="home-container animate-fade-in">
            ...
            <header className="home-header">
                <div className="logo-container">
                    <img className="app-logo-img header-logo-img" src={ranstalLogo} alt="Ranstal logo" />
                    <h2 className="app-name">RANSTAL</h2>
                </div>
            ...
            <main className="home-content">
                ...
                <h1 className="hero-title">
                    Ransel Digital <br />
                    <span className="text-gradient">Kesehatan Wisatamu.</span>
                </h1>

                <p className="hero-description">
                    RANSTAL - Ransel Digital Travel Health Nursing menjaga keselamatan dan kesehatan anak selama perjalanan wisata dengan panduan pertolongan pertama, pemantauan kesehatan, dan konsultasi AI.
                </p>
                ...
                {dailyQuote && (
                    <div className="daily-affirmation glass-card hover-lift" style={{ 
                        ...
                        <h4 style={{ fontSize: '13px', fontWeight: '700', color: '#15803d', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '1px' }}>Tips Perjalanan Sehat Hari Ini</h4>
                ...
                <div className="glass-card" style={{ width: '100%', maxWidth: '500px', marginBottom: '24px', padding: '18px', borderRadius: '20px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                        <strong style={{ fontSize: '14px', color: '#0f172a' }}>Pangkat Traveler Sehat</strong>
                ...
                <div className="daily-challenge-box glass-card" style={{ width: '100%', maxWidth: '500px', padding: '18px', borderRadius: '20px', backgroundColor: '#ffffff' }}>
                    <h3 style={{ fontSize: '15px', fontWeight: '700', marginBottom: '14px', color: '#123e42', display: 'flex', alignItems: 'center', gap: '8px', textAlign: 'left' }}>
                        🎯 Checklist Kesehatan Perjalanan
                    </h3>
                    <p style={{ fontSize: '13px', color: '#64748b', marginBottom: '14px', textAlign: 'left' }}>Selesaikan tugas untuk menaikkan level kesehatan perjalanan:</p>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                        ...
                        >
                            ...
                            <span style={{ fontSize: '13.5px', fontWeight: '500', color: dailyTasks.drinkWater ? '#15803d' : '#334155', textDecoration: dailyTasks.drinkWater ? 'line-through' : 'none' }}>Minum air putih minimal 2 liter selama perjalanan</span>
                        </div>
                        ...
                        >
                            ...
                            <span style={{ fontSize: '13.5px', fontWeight: '500', color: dailyTasks.scanDrink ? '#15803d' : '#334155', textDecoration: dailyTasks.scanDrink ? 'line-through' : 'none' }}>Cek kelengkapan obat & P3K</span>
                        </div>
                        ...
                        >
                            ...
                            <span style={{ fontSize: '13.5px', fontWeight: '500', color: dailyTasks.noSugar ? '#15803d' : '#334155', textDecoration: dailyTasks.noSugar ? 'line-through' : 'none' }}>Gunakan masker & jaga kebersihan tangan</span>
                        </div>
                        ...
                        >
                            ...
                            <span style={{ fontSize: '13.5px', fontWeight: '500', color: dailyTasks.walkTenMin ? '#15803d' : '#334155', textDecoration: dailyTasks.walkTenMin ? 'line-through' : 'none' }}>Istirahat cukup & aktif bergerak 10 menit</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="additional-features-box glass-card" style={{ width: '100%', maxWidth: '500px', marginTop: '24px', padding: '20px', borderRadius: '16px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '12px' }}>
                        <div onClick={() => navigate('/scan')} style={{ padding: '18px 12px', backgroundColor: '#e6f7f5', borderRadius: '16px', textAlign: 'center', border: '1px solid #b2e3dd', cursor: 'pointer', transition: 'all 0.3s' }} className="hover-lift">
                          ...
                          <span style={{ fontSize: '13px', color: '#0f766e', fontWeight: '700' }}>Ranstal Check</span>
                        </div>
                        <div onClick={() => navigate('/chat')} style={{ padding: '18px 12px', backgroundColor: '#eff6ff', borderRadius: '16px', textAlign: 'center', border: '1px solid #bfdbfe', cursor: 'pointer', transition: 'all 0.3s' }} className="hover-lift">
                          ...
                          <span style={{ fontSize: '13px', color: '#1d4ed8', fontWeight: '700' }}>Konsul Travel AI</span>
                        </div>
                        <div onClick={() => navigate('/checklist')} style={{ padding: '18px 12px', backgroundColor: '#fff7ed', borderRadius: '16px', textAlign: 'center', border: '1px solid #ffedd5', cursor: 'pointer', transition: 'all 0.3s' }} className="hover-lift">
                          <Activity size={28} color="#ea580c" style={{ display: 'block', margin: '0 auto 8px auto' }} />
                          <span style={{ fontSize: '13px', color: '#c2410c', fontWeight: '700' }}>Checklist</span>
                        </div>
                        <div onClick={() => navigate('/progress')} style={{ padding: '18px 12px', backgroundColor: '#faf5ff', borderRadius: '16px', textAlign: 'center', border: '1px solid #f3e8ff', cursor: 'pointer', transition: 'all 0.3s' }} className="hover-lift">
                          ...
                          <span style={{ fontSize: '13px', color: '#6d28d9', fontWeight: '700' }}>Info Destinasi</span>
                        </div>
                        <div onClick={() => navigate('/game')} style={{ padding: '18px 12px', backgroundColor: '#f0fdf4', borderRadius: '16px', textAlign: 'center', border: '1px solid #bbf7d0', cursor: 'pointer', transition: 'all 0.3s' }} className="hover-lift">
                          ...
                          <span style={{ fontSize: '13px', color: '#15803d', fontWeight: '700' }}>Game Safety Rush</span>
                        </div>
                        <div onClick={() => navigate('/travel-game')} style={{ padding: '18px 12px', backgroundColor: '#eef2ff', borderRadius: '16px', textAlign: 'center', border: '1px solid #c7d2fe', cursor: 'pointer', transition: 'all 0.3s' }} className="hover-lift">
                          <MapPin size={28} color="#4f46e5" style={{ display: 'block', margin: '0 auto 8px auto' }} />
                          <span style={{ fontSize: '13px', color: '#4338ca', fontWeight: '700' }}>Game Persiapan Wisata</span>
                        </div>
                        <div onClick={() => navigate('/tracking')} style={{ padding: '18px 12px', backgroundColor: '#ecfeff', borderRadius: '16px', textAlign: 'center', border: '1px solid #a5f3fc', cursor: 'pointer', transition: 'all 0.3s', gridColumn: 'span 2' }} className="hover-lift">
                          <Navigation size={28} color="#0f766e" style={{ display: 'block', margin: '0 auto 8px auto' }} />
                          <span style={{ fontSize: '13px', color: '#115e59', fontWeight: '700' }}>GPS Tracker Orang Tua</span>
                        </div>
                    </div>
                </div>

                {/* Health Services and Emergency Features */}
                <div className="emergency-features-box glass-card" style={{ width: '100%', maxWidth: '500px', marginTop: '24px', padding: '20px', borderRadius: '16px' }}>
                    <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '16px', color: '#1e293b', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                        🏥 Layanan Kesehatan & Bantuan
                    </h3>
                    
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '12px' }}>
                        <div onClick={() => window.open('https://haryyanna.github.io/ranstal-lacakes/', '_blank')} style={{ padding: '18px 12px', backgroundColor: '#fee2e2', borderRadius: '16px', textAlign: 'center', border: '1px solid #fecaca', cursor: 'pointer', transition: 'all 0.3s' }} className="hover-lift">
                          <MapPin size={28} color="#dc2626" style={{ display: 'block', margin: '0 auto 8px auto' }} />
                          <span style={{ fontSize: '13px', color: '#b91c1c', fontWeight: '700' }}>Cari Layanan Kesehatan</span>
                        </div>
                                                <a href="tel:112" style={{ padding: '18px 12px', backgroundColor: '#fef3c7', borderRadius: '16px', textAlign: 'center', border: '1px solid #fde68a', cursor: 'pointer', transition: 'all 0.3s', textDecoration: 'none' }} className="hover-lift">
                          <Phone size={28} color="#d97706" style={{ display: 'block', margin: '0 auto 8px auto' }} />
                                                    <span style={{ fontSize: '13px', color: '#b45309', fontWeight: '700' }}>Telepon Darurat 112</span>
                                                </a>
                    </div>
                </div>
                    ...
                    <div className="modal-overlay" onClick={() => setShowWelcome(false)} style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(4px)', zIndex: 10000, display: 'flex', justifyContent: 'center', alignItems: 'flex-start', paddingTop: '10vh' }}>
                        <div className="modal-content glass-card animate-fade-in" onClick={e => e.stopPropagation()} style={{ width: '90%', maxWidth: '400px', padding: '32px 24px', textAlign: 'center', borderRadius: '24px', background: '#ffffff', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}>
                            ...
                            <p style={{ fontSize: '14px', color: '#64748b', lineHeight: '1.6', marginBottom: '24px' }}>
                                Senang melihatmu di RANSTAL. Kami siap menjaga keselamatan dan kesehatan anak selama perjalanan wisata dengan panduan pertolongan pertama, pemantauan kesehatan, dan konsultasi AI.
                            </p>
